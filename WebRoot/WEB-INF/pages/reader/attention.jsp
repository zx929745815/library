...
<br>
3、读者对所借图书应如期归还，请您留意每日的还书日期提示牌,在借书时记住应该归还的日期，按期还书，（您当天借阅/续借的图书当天不得归还）如到期未阅读完，应携带读者卡（可不必带书）到
<br>外借处办理续借手续，或电话续借，允许续借一次，具体续借天数请参看借阅权限（续借图书一定要在还期内进行，否则过期后将不可再续借）。<br>
<br>
