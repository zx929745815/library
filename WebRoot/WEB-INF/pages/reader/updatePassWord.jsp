...
<div class="panel admin-panel">
  ...
  <div class="body-content">
    <form method="post" class="form-x" action="" id="updatepwd">
      <div class="form-group">
        <div class="label">
          <label for="sitename">帐&nbsp;号：</label>
        </div>
        <div class="field">
      ...
      <div class="form-group">
        ...
        <div class="field">
          <button class="button bg-main icon-check-square-o" type="button" id="update"> 提交</button>   
        </div>
      </div>      
    </form>
  </div>
...
$('#update').click(function(){
	...
	alert(data.toString());
	   ...
	   $.ajax({
		url : "/library/reader/updatePassWord.do",
		type : "post",
		data : data,
		dataType : "json",
